    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div>
        ...
        <input
          ...
          required
          className="bg-surface text-text border-border focus-visible:ring-[var(--ctp-mauve)] focus-visible:border-transparent w-full rounded-lg p-3 transition-colors outline-none focus-visible:ring-2"
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="bg-surface text-text border-border focus-visible:ring-[var(--ctp-mauve)] focus-visible:border-transparent w-full appearance-none rounded-lg p-3 transition-colors outline-none focus-visible:ring-2"
          >
          ...
          <div className="mt-2 flex gap-2">
            {[15, 30, 45, 60].map((mins) => (
              <button
                ...
                className={`focus-visible:ring-[var(--ctp-mauve)] rounded-full px-3 py-1 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:outline-none ${
      ...
      <div className="flex items-center gap-3 py-2">
        <input
          ...
          className="border-border text-primary bg-surface h-5 w-5 rounded focus-visible:border-transparent focus-visible:ring-2 focus-visible:ring-[var(--ctp-mauve)] focus-visible:outline-none"
        />
        <label
          htmlFor="all_day"
